package dev.vality.http.client.util;
...
public class SslCertificateUtil {
    ...
    public static final String KEYSTORE_PASSWORD = "very_secure";

    @SneakyThrows
    public static KeyStore getKeyStore(String certificatePem, String privateKeyPem) {
        try {
            ...
            keyStore.setKeyEntry("client-key", privateKey, KEYSTORE_PASSWORD.toCharArray(),
